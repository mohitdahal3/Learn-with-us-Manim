...
class ExtraScene1(Scene):
    def construct(self):
        text1 = Text("Remember that the area under the original curve " , color=BLUE , stroke_color=BLUE , stroke_opacity = 1)
        text2 = Text("represents the TOTAL distance travelled between 0 and 5 seconds." , color=BLUE , stroke_color=BLUE , stroke_opacity = 1)
        text = VGroup(text1 , text2).arrange(DOWN).scale(0.7)
        animations = [
            Write(text1),
            Write(text2)
        ]
